...
const PRESETS: Preset[] = [
  {
    ...
    description:
      "Chief of Staff: triage messages, create tickets when warranted, delegate to specialist agents, keep Noah in the loop.",
    files: {
  ...
  },
  {
    ...
    description:
      "Ops/Reliability: VPS health, OpenClaw/Hub uptime, deploys, debugging, safe changes with rollback.",
    files: {
  ...
  },
  {
    ...
    description:
      "Developer: implements Hub features, fixes bugs, ships small clean diffs, keeps mobile UX polished.",
    files: {
  ...
  },
  {
    ...
    description:
      "Research: finds primary sources and produces cited summaries/comparisons to unblock decisions.",
    files: {
